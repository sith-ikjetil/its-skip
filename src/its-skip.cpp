...
namespace ItSoftware::ItsSkip
{
    ...
    int ParseArguments(int argc, const char* argv[], ItsSkipArguments& args);
...
//      Redirects main to Itsoftware::ItsSkip::main.
//
int main(int argc, const char* argv[])
{
    return ItSoftware::ItsSkip::main(argc, argv);
}